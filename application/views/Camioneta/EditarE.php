...
<div class="container">
    ...
    <form action="<?= base_url('index.php/CamionetasC/EditarE/').$deta[0]->idcamioneta?>" method="POST">
        <div class="row">
            <div class="row">
            ...
            <div class="col-4">
                    <div class="mb-3">
                        ...
                        <select name="modelo" value="<?= $deta[0]->modelo?>">
                ...
                <div class="col-4">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="fecha_compra" value="<?= $deta[0]->fecha_compra?>">
                    </div>
                </div>
                ...
                <div class="col-4">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="peso_carga" value="<?= $deta[0]->peso_carga?>">
                    </div>
                </div>
                ...
                <div class="col-4">
                    <div class="mb-3">
                        ...
                        <select name="pais_de_origen" value="<?= $deta[0]->pais_de_origen?>">
                ...
                <div class="col-4">
                    <div class="mb-3">
                        ...
                        <select name="clase_vehiculo" value="<?= $deta[0]->clase_vehiculo?>">
